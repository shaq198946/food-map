...
### 6.25 品牌标识全链路升级为「美食红黑榜 · 河南」
- **用户需求**：品牌名称后面增加后缀标识，正式升级为 **「美食红黑榜 · 河南」**；
- **全链路同步实施**：
  1. **Web 页面 Title 与品牌顶栏**：`index.html` 的 `<title>`、开屏加载页品牌文字、顶栏品牌名称全部升级为 **`美食红黑榜 · 河南`**；
  2. **微信小程序原生导航**：`miniprogram-1/app.json` 的 `navigationBarTitleText` 升级为 **`美食红黑榜 · 河南`**；
  3. **项目工程与设计文档**：`README.md`、`DEVELOPMENT.md`、`PROCESS.md` 全面同步版本升至 v3.8.1。
